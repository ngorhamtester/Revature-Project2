...
@Entity
@Table(name="playlists", schema="sortify")
public class Playlist {
	//Private variables
	@Id @Column(name="spotify_playlist_id")
	...
	public Playlist(String spotifyPlaylistId, String spotifyPlaylistName, 
			String spotifyPlaylistUri, User user) {
		super();
	 ...
	 * Get Spotify User
	 * 
	 * @return spotifyUser User Spotify user
	 */
	 ...
	 * Set Spotify User
	 * 
	 * @param spotifyUser User Spotify user
	 */
	...
	public int hashCode() {
		...
		result = prime * result + ((spotifyUser == null) ? 0 : spotifyUser.hashCode());
		return result;
	}
	...
	public boolean equals(Object obj) {
		...
		if (spotifyPlaylistUri == null) {
			...
			return false;
		if (spotifyUser == null) {
			if (other.spotifyUser != null)
				return false;
		} else if (!spotifyUser.equals(other.spotifyUser))
			return false;
		return true;
	}
	...
	public String toString() {
		return "Playlist [" 
				...
				+ "\nspotifyUser = " + spotifyUser.toString()
				+ "\n]";
	}
}
